    ...
    constructor(size, resolution, scaleFactor) {
        ...
        guiTerrainControls.add(this.guiParams, "Algorithm", ["Value Noise", "Perlin Noise", "Diamond Square"]).onChange((value) => {
            ...
            if (this.currentAlgorithm == "Diamond Square") {
                ...
                this.resolutionController = guiTerrainControls.add(this.guiParams, "Resolution", [16,32,64,128]).onChange((value) => {
                    this.resolution = parseInt(value);
                    this.gridSize = this.size/this.resolution;
                    this.GenerateTerrain();
                });
            } else {
                this.resolutionController = guiTerrainControls.add(this.guiParams, "Resolution", 1, 200).step(1).onChange((value) => {
