...
class Terrain {
    ...
    PerlinNoise() {
        ...
        const grad = [
            ...
            new Gradient(Math.sqrt(2),0),
            new Gradient(0,Math.sqrt(2)),
            new Gradient(-Math.sqrt(2),0),
            new Gradient(0, -Math.sqrt(2)),
        ];
        ...
        function noise(u,v,self) {
            ...
            let aG = grad[(iU+p[iV])%8];
            let bG = grad[(iU+p[iV+1])%8];
            let cG = grad[(iU+1+p[iV])%8];
            let dG = grad[(iU+1+p[iV+1])%8];
        ...
        var largest = 0;
        var smallest = 100;
        var smallestX = 100000000;
        var smallestZ = 100000000;
        ...
        for (let i=0;i<this.Verticies.length;i++) {
            ...
            for (let j=0;j<this.Verticies[0].length;j++) {
                ...
                console.log("X: ",x/(width*this.gridSize));
                ...
                this.Verticies[i][j].y = noiseValue *400;

            }
        }

        console.log("Smallest: ", smallest);
        console.log(smallestX,smallestZ);
